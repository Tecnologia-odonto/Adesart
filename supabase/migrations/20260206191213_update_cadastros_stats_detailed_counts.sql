/*
  # Atualizar função get_cadastros_stats para retornar contagem detalhada
  
  1. Alterações
    - Modifica get_cadastros_stats para retornar contagens separadas de cadastros e dependentes
    - Mantém compatibilidade com campos totais (_total = _cadastros + _dependentes)
  
  2. Estrutura do Retorno
    Para tipo "cadastro":
    - cadastro_total: Total (cadastros + dependentes)
    - cadastro_cadastros: Quantidade de cadastros (titulares)
    - cadastro_dependentes: Quantidade de dependentes
    - cadastro_incompletos: Total incompletos
    - cadastro_incompletos_cadastros: Incompletos titulares
    - cadastro_incompletos_dependentes: Incompletos dependentes
    - cadastro_enviados: Total enviados
    - cadastro_enviados_cadastros: Enviados titulares
    - cadastro_enviados_dependentes: Enviados dependentes
    
    Para tipo "inclusao_dependente":
    - inclusao_total: Total (cadastros + dependentes)
    - inclusao_cadastros: Quantidade de cadastros (titulares)
    - inclusao_dependentes: Quantidade de dependentes
    - inclusao_incompletos: Total incompletos
    - inclusao_incompletos_cadastros: Incompletos titulares
    - inclusao_incompletos_dependentes: Incompletos dependentes
    - inclusao_enviados: Total enviados
    - inclusao_enviados_cadastros: Enviados titulares
    - inclusao_enviados_dependentes: Enviados dependentes
*/

-- Dropar função anterior
DROP FUNCTION IF EXISTS get_cadastros_stats(uuid);

-- Criar função get_cadastros_stats com contagens detalhadas
...
-- Comentários
COMMENT ON FUNCTION get_cadastros_stats IS 'Retorna estatísticas detalhadas de cadastros do mês atual separadas por tipo_cadastro (cadastro e inclusao_dependente). Inclui contagem separada de cadastros titulares e dependentes.';